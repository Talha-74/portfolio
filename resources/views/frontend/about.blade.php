    ...
    <div class="container">
        <div class="tokyo_tm_about">
            ...
            <div class="about_text">
                <p>Hi, my name is Adriano Smith and I began using WordPress when it first began. I’ve
                    spent most of my waking hours for the last ten years designing, programming and
                    operating WordPress sites.</p>
                <p>One of my specialties is taking an idea from scratch and creating a full-fledged
                    ...
                    look-and-feel. With extensive knowledge of web mechanics, I’m able to optimize
                    complex integrations to require little-to-no maintenance while running on their own
                    for years.</p>
            </div>
                    ...
                    <div class="tokyo_tm_info">
                        <ul>
                            ...
                            <li><span>Email:</span><span><a
                                        href="https://marketifythemes.net/cdn-cgi/l/email-protection#05716a6e7c6a456268646c692b666a68"><span
                                            class="__cf_email__"
                                            data-cfemail="dfabb0b4a6b09fb8b2beb6b3f1bcb0b2">[email&#160;protected]</span></a></span>
                            </li>
                            <li><span>Phone:</span><span><a href="tel:+77 022 177 05 05">+77 022 177 05
                                        05</a></span></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="in">
                <div class="left">
                    ...
                    <div class="tokyo_progress">
                        ...
                        <div class="progress_inner" data-value="90">
                            <span><span class="label">Angular</span><span
                ...
                <div class="right">
                    ...
                    <div class="tokyo_progress">
                        ...
                        <div class="progress_inner" data-value="95">
                            <span><span class="label">Russian</span><span
                                    class="number">95%</span></span>
                            <div class="background">
                                <div class="bar">
                                    <div class="bar_in"></div>
                        ...
                        <div class="progress_inner" data-value="85">
                            <span><span class="label">Arabic</span><span
            ...
            <div class="in">
                <div class="left">
                    ...
                    <div class="tokyo_tm_skill_list">
                        <ul>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Bootstrap,
                                    Angular</span>
                            </li>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />React, Vue,
                                    Laravel</span>
                            </li>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Stylus, Sass,
                                    Less</span>
                            </li>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Gulp, Webpack,
                                    Grunt</span>
                            </li>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Tweenmax,
                                    GSAP</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="right">
                    ...
                    <div class="tokyo_tm_skill_list">
                        <ul>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Make UI/UX
                                    Design</span>
                            </li>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Create Mobile
                                    App</span>
                            </li>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Site
                                    Optimization</span>
                            </li>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Custom
                                    Website</span>
                            </li>
                            <li>
                                <span><img class="svg" src="img/svg/rightarrow.svg" alt />Learn
                                    Ecommerce</span>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="list">
                <ul class="owl-carousel">
                    <li>
                        <div class="list_inner">
                            <div class="text">
                                <p>Beautiful minimalist design and great, fast response with support.
                    ...
                    <li>
                        <div class="list_inner">
                            <div class="text">
                                <p>I had a little problem and the support was just awesome to quickly
                                    solve the situation. And keep going on.</p>
                            </div>
                            <div class="details">
                                <div class="image">
