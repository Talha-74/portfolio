...
@section('content')
    <div id="home" class="tokyo_tm_section animated fadeInUp active">
        <div class="container">
            <div class="tokyo_tm_home">
                <div class="home_content">
                    <div class="avatar" data-type="wave">
                        <div class="image" data-img-url="img/slider/1.jpg"
                            style="background-image: url(&quot;img/slider/1.jpg&quot;);"></div>
                    </div>
                    <div class="details">
